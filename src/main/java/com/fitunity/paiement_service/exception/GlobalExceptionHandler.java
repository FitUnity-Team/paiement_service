...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(
            PaiementNotFoundException ex) {
        return buildError(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(InvalidPaiementStateException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidState(
            InvalidPaiementStateException ex) {
    ...
    private ResponseEntity<Map<String, Object>> buildError(
        ...
        error.put("erreur", status.getReasonPhrase());
